...
class AquiferData:
    ...
    def initialize(self):
        ...
        self.lab2.shape = (self.Naq, self.model.Nin, self.model.Npin)
...
class Aquifer(AquiferData):
    def __init__(self, model, kaq, Haq, c, Saq, Sll, topboundary, phreatictop):
        ...
        AquiferData.__init__(self, model, kaq, c, z, npor, ltype, Saq, Sll, phreatictop)
        self.inhomList = []
