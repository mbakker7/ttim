...
1. :class:`~ttim.well.Well` is a well for which the total discharge is specified.
The discharge may be continuous between specified times or may be a slug. The total discharge is distributed across the layers in which the
well is screened such that the head inside the well is the same in each screened layer. Skin effect and wellbore storage may be included.
...
the head in all screened layers is equal to the specified head. Skin effect may be included. 
