...
Line-sinks are lines along which water is taken out of or put into the aquifer. The inflow/outflow along the line-sink does not vary along a line-sink.
There are two types of line-sinks: line-sinks for which the head is specified at the center of the line-sink, and line-sinks for which the total discharge is specified
...
.. toctree::
    ...
    LineSinkDitchString <linesinkditchstring>
